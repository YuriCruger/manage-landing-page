    ...
    return (
        <div>
            ...
            <div className=" relative">
                ...
                >
                    ...
                    <SwiperSlide>
                        <div className="bg-veryPaleRed flex flex-col items-center justify-center gap-4 text-center relative py-4 px-2">
                            ...
                            <h3 className='text-darkBlue font-bold text-xl'>
                                Anisha Li
                            </h3>
                ...
                <Button className="flex mx-auto mt-10 shadow-md bg-brightRed font-bold rounded-3xl px-10 hover:opacity-70 hover:bg-brightRed transition duration-300 easy-in-out">Get Started</Button>
            </div>
        </div>
    )
}
